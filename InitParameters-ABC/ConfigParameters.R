...
#In river
sp_maxRIV = 5 #matrix_param[row,"maxRIV"] #5 # al+mb 04-2021
...
sp_Sp0 = 0.98912 #matrix_param[row,"sp0"] #0.98912  #0.9841606*1.0025
...
sp_Sp1 = 0.996 #matrix_param[row,"sp1"] #0.996 #0.995 #0.9962 #0.9914398*1.002
